...
const LoginContainer = props => {
    ...
    return (
        <div>
            ...
            <Button variant="info" onClick={() => { auth.login(() => { bypassLogin(props, 'companyHr') }); }}>ByPass Admin Login</Button>{' '} &nbsp;&nbsp;
            <Button variant="info" onClick={() => { auth.login(() => { bypassLogin(props, 'candidateRole') }); }}>ByPass Consumer Login</Button>{' '}
