        ...
        <div>
            <center>
                <Card style={{ width: '48rem', backgroundColor: '#68FFDC' }}>
                    <Card.Body>
                        <Card.Title>Upload Resume Page</Card.Title>
                        <form encType="multipart/form-data" onSubmit={uploadImageInServer}>
                            <label for="resumeUploadFile">Select Resume:&nbsp;&nbsp;  </label>
                            <input type="file" id="resumeUploadFile" name="resumeUploadFile" accept="image/*,.pdf,.doc,.docx" onChange={handleChange} />
