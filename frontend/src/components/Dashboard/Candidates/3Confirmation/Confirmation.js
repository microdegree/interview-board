                ...
                <Card style={{ width: '48rem', backgroundColor: '#68FFDC' }}><Card.Body>
                    ...
                    <Row>
                        ...
                        <Col>
                            ...
                            <Row style={{ fontWeight: "bold", fontSize: '20px' }}>Location @ {props.location.projectData.jobLocation}</Row>
                            <Row style={{ fontWeight: "bold", fontSize: '20px' }}>technologyType Name : {props.location.projectData.technologyType}</Row>
